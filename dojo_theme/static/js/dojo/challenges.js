...
function startChallenge(event) {
    ...
    CTFd.fetch('/pwncollege_api/v1/docker', {
        ...
        if (result.success) {
            var message = `Challenge successfully started! You can interact with it through a <a href="/workspace/vscode" target="_blank">VSCode Workspace</a> or a <a href="/workspace/desktop" target="_blank">GUI Desktop</a>.`;
